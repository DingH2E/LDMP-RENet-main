...
def get_parser():
    parser = argparse.ArgumentParser(description='Local Descriptor-based Graph Reasoning Network')
    parser.add_argument('--config', type=str, default='config/resnet/fold0_resnet50.yaml', help='config file')
